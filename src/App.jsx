...
const starterData = [
  ...
  {
    id: 2,
    gadgetName: 'AeroBook 14',
    category: 'Laptop',
    manufacturer: 'Aero Computing',
    healthRating: 88,
    techBrand: 'Aero',
    userRole: 'Tester'
  },
  ...
  {
    id: 4,
    gadgetName: 'Sonic Buds',
    category: 'Audio',
    manufacturer: 'Sonic Works',
    healthRating: 82,
    techBrand: 'Sonic',
    userRole: 'Engineer'
  }
...
export default function App() {
  ...
  const validateField = (name, value) => {
    ...
    if (
      ['gadgetName', 'manufacturer', 'techBrand'].includes(name) &&
    ...
    if (
      ...
      return 'Health rating must be from 1 to 100.'
    }
    ...
    () => [
      {
        ...
        header: 'Gadget',
        cell: info => {
          const Icon = categoryIcon[info.row.original.category]

          return (
            <div className={styles.gadgetCell}>
              ...
              <div>
                <b>{info.getValue()}</b>
                <small>{info.row.original.techBrand}</small>
              </div>
            </div>
          )
        }
  ...
  const averageHealth = Math.round(
    items.reduce(
      (sum, item) => sum + item.healthRating,
      0
    ) / items.length
  )
      ...
      <main>
        ...
        <header>
          ...
          <div>
            ...
            <span>
              Register, inspect, and monitor every device
            </span>
          </div>
        ...
        <section className={styles.stats}>
          ...
          <article>
            ...
            <div>
              ...
              <p>
                {healthLabel(averageHealth)} inventory condition
              </p>
            </div>
          ...
          <section className={styles.formPanel}>
            ...
            <div className={styles.sectionTitle}>
              <div>
                ...
                <p>
                  All fields are required. Validation happens as you type.
                </p>
              </div>
            </div>
            ...
            {activeItem ? (
              ...
              <div className={styles.profile}>
                ...
                <div className={styles.heroIcon}>
                  {(() => {
                    const Icon =
                      categoryIcon[activeItem.category]
                ...
                <h3>
                  {activeItem.gadgetName}
                </h3>

                <p>
                  {activeItem.techBrand}
                </p>

                <span
                  className={`${styles.badge} ${
                    activeItem.userRole === 'Engineer'
                      ? styles.engineer
                      : styles.tester
                  }`}
                >
              ...
              <div className={styles.empty}>
                Select a row to inspect its profile.
              </div>
