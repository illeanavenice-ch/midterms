...
export default function App() {
  ...
  return <div className={styles.app}>
    <aside className={styles.sidebar}>
      ...
      <div className={styles.sidebarBottom}><small>TECH OPERATIONS</small><div className={styles.avatar}>AB</div><div><b>Angelica Biaga</b><span>Administrator</span></div></div>
    </aside>
